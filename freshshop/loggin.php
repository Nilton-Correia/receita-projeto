    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="html/index.html"><img src="images/logo.png" class="logo" alt=""></a>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-6 mb-3">
                <div class="row">
                    ...
                    <div class="col-12 d-flex shopping-box"> <a href="html/checkout.html" class="ml-auto btn hvr-hover">Place Order</a> </div>
                </div>
            </div>
        </div>
