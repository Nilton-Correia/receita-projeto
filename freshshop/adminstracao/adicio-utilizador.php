                                                        ...
                                                        <div class="box">
                                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                                                ...
                                                                <div class="input-field  <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                                                                    ...
                                                                    <input placeholder="Nome do utilizador" id="<?php echo $username; ?>" name="username" type="text" class="input is-large" >
                                                                </div>
                                                                <div class="input-field <?php echo (!empty($nome_err)) ? 'has-error' : ''; ?>">
                                                                    <input placeholder="Nome completo" id="<?php echo $nome; ?>" name="nome" type="text" class="input is-large">
                                                                </div>
