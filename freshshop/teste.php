                ...
                <div class="table-main table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td class="quantity-box"><input  type="number" size="4" value="<?php echo $result['quantity']?>" min="0" step="1" name="prod[<?php echo $result['idreceita']?>]" class="c-input-text qty text"></td>
                            <td class="total-pr">
